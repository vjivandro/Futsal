...
import com.futsal.app.futsalapp.Utils.ItemDecorationColumns;
    ...
    private class DasboardAdapter extends RecyclerView.Adapter<DasboardAdapter.ViewHolder>{
        ...
        public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                if (getPosition() == 0) {
                    startActivity(new Intent(v.getContext(), MateriActivity.class));
                } else if (getPosition() == 1) {
                    startActivity(new Intent(v.getContext(), MetodeLatihanActivity.class));
                } else if (getPosition() == 2) {
                    startActivity(new Intent(v.getContext(), TentangActivity.class));
                } else if (getPosition() == 3) {
                    startActivity(new Intent(v.getContext(), PetunjukActivity.class));
                }
            }
        }
    }
